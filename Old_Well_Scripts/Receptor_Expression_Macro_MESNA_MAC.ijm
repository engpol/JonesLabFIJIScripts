...
for (i = 0; i < lengthOf(filelist); i++) {
	...
	imageCalculator("Multiply create stack", "Corrected_Flo_Image.tiff","PHANTAST_Combined_Stack"); //Multiply Fluoresence stack by mask so only fluoresence from cell containing regions is included
